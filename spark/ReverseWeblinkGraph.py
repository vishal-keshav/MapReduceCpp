...
if __name__ == "__main__":
    ...
    target_sources = sc.textFile('data/ReverseWeblinkGraphInput.txt').map(lambda line: get_target_source(line))
    ...
    output_file_loc="build/ReverseWeblinkGraphData/ReverseWeblinkGraph_SparkOutput.txt"
